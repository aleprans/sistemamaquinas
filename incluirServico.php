...
if ($serv > 0) {
    $sql = "UPDATE servicos SET id_cliente = '$cli', equipamento = '$equi', descricao = '$desc', pecas = '$peca', valor_pecas = '$vpeca', valor_total = '$val', dat_exec = '$data', fim = $fim WHERE  id_servico = '$serv'";
    $resultado = mysqli_query($connect, $sql);
} else {
    $sql = "INSERT INTO servicos(id_cliente, equipamento, descricao, pecas, valor_pecas, valor_total, dat_exec, fim) VALUES ('$cli', '$equi', '$desc', '$peca', '$vpeca', '$val', '$data', $fim)";
    $resultado = mysqli_query($connect, $sql);
}
